...
public class Boosting implements Oracle {
   ...
   protected static org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger(Boosting.class.getName());
   ...
   protected class BoostingOutputOracle implements OutputOracle {
