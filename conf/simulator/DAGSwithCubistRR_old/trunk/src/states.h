...
typedef struct _cubist_statistics {
	float remoteNodesInCommit;
	float prepareRate;
	float commitRate;
	float rollbackRate;
	float remoteGetRate;
...
typedef struct _SERVER_lp_state_type {
	...
	double average_net_interarrival_tx_time;
	double last_net_iterarrival_tx_time;
	cubist_statistics cubist_stats;
